F2L FUNCTIONAL 2 LIVE - ITS207 WEBSITE
...
2. Open index.html in Chrome to review the website.
3. Test every navigation link and mobile layout.
4. Upload the complete folder to a static host such as GitHub Pages.
5. Add the final live URL and screenshots to the assessment report.
